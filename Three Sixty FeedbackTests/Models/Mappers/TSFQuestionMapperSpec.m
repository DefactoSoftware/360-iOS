...
describe(@"TSFQuestionMapper", ^{
    ...
    __block TSFQuestionMapper *_questionMapper;
    ...
    it(@"maps a question correctly", ^{
        ...
        [_questionMapper questionWithDictionary:questionDictionary];
    ...
    it(@"maps an array of questions correctly", ^{
        NSArray *questions = [_questionMapper questionsWithDictionaryArray:_sampleDictionaryArray];
